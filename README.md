...
For transparency into our release cycle and in striving to maintain the backward compatibility, Bootstrap is maintained under [the Semantic Versioning guidelines](http://semver.org/). Sometimes we screw up, but we'll adhere to those rules whenever possible.
...
## GitAds Sponsored
[![Sponsored by GitAds](https://gitads.dev/v1/ad-serve?source=arnabnandy7/bootstrap@github)](https://gitads.dev/v1/ad-track?source=arnabnandy7/bootstrap@github)
